...
#include "SQLTableModifier_ModifyColumn.generated.h"

using namespace LeafMySql;

UCLASS(BlueprintType)
class LEAFMYSQL_API USQLTableModifier_ModifyColumn : public USQLTableModifier
{
